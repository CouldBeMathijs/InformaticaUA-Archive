...
class SimpleBGP(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        self.addAS(1, routers=[as1ra,as1rb,as1rc,as1rd])
        self.addAS(2, routers=[as2ra,as2rb,as2rc,as2rd])
        self.addAS(3, routers=[as3ra,as3rb,as3rc,as3rd])
        ...
        # Add eBGP peering
        ebgp_session(self, as1rc, as2ra)
        ebgp_session(self, as2rc, as3ra)
        ebgp_session(self, as3rc, as1ra)
